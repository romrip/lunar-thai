...
st.title("โปรแกรมคำนวณธาตุ")
st.write("วิเคราะห์ธาตุเจ้าเรือนและสมุฏฐานการเกิดโรค")
...
# ==========================================
st.subheader("1. ข้อมูลวันเกิด (ธาตุเจ้าเรือนปฏิสนธิ)")
...
# ==========================================
st.subheader("2. ข้อมูลการเกิดโรค (อุตุ อายุ กาล ประเทศสมุฏฐาน)")
